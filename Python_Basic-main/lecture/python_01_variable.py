...
#참고: Escape Code
# -문법: \(역 슬러쉬) +@
# -문자열(String) 내의 일부 문자의 의미를 달리 하여 특정한 효과 주기
# - 예) \n: 한 줄 개행, \t: 탭(8칸 공백)
print("=" * 100)
print("Hello \n Python")
print("Hello \t Python")
...
# 4) 논리형(boolean): True,False (무조건 대문자로 써야 인식함)
...
# 문자열 정수형("3") -> 정수형(3)
# 문자열 정수형("3") -> 실수형 (3.0)
# 문자열 정수형("3.14") -> 정수형(Error)
#print(int(str_float_d))
# 문자열 정수형("3.14") -> 실수형(3.14)
...
#  abc1(0),1abc(x)
# 3. 영어 대소문자 구별
#  abc ABC Abc ABc abc 다 다른 변수로 인식함
# 4. 예약어 사용 불가
...
# 9. 동적 출력
print("="*200)
student_num = 20233183
student_name = "Son"
# 출력 예: "조선대학교 20233183, Son 입니다."
print("조선대학교 20233183, Son 입니다.")  #하드코딩 지양
#1. format() - 오래된 방식
