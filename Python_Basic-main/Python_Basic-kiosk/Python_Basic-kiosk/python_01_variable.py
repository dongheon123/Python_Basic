...
# name 변수 생성
# "leeseojune" 값을 name 변수에 담기

# name (변수명), =(대입 연산자), "leeseojune"(값)
name = "leeseojune"
...
#       abc12(O), 1abc(X)
#  3.영어 대소문자 구별
#       abc Abc aBc abC ABc 모두 다른 변수
#  4.예약어 사용 불가
#    예약어: python에서 미리 선점하여 사용중인 키워드
#           ex) print, for , while, if ,else, class,try,except,Ture,False
#           and, return,import, def, pass, break, continue, del, ///
# Naming Method
#  - 변수, 함수, 클래스 등의 사용자 정의 이름에 사용하는 기법
#  - 프로그래밍 언어마다 사용하는 Naming Method가 다름!
...
# 동적 출력!
print("=" * 200)
student_num = 20233154
student_name = "leeseojune"

# 출력 예 : "조선대학교 20233154, leeseojune 입니다."
print("조선대학교 20233154,  leeseojune 입니다.") # 하드 코딩 지양!
