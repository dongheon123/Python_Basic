...
# name 변수 생성
# "Seodongheon" 값을 name 변수에 담기
# name(변수명), =(대입연산자), "Seodongheon"(값)
name = "Seodongheon"

# 명령 규칙(Naming Rule)
# * 변수, 함수, 클래스 등의 사용자 정의 이름을 붙을 때 사용!
# * 명확하고 알아보기 쉽게 짓기!
#
...
#   ex) abc1 (O), 1abc (X)
#   3. 영어 대소문자 구별
#   ex) abc, Abc, abC, ABC - 모두 다른 변수
#   4. 예약어 사용 불가
#   예약어: Python 에서 미리 선점하여 사용중인 키워드
#   ex) print, for, while, if, else class, try, except,
#       True, False, and, return, import, def, pass, break, continue, del ...
...
#   ex) studentName
# 3. PascalName: 첫글자 대문자, 합성어 첫글자 대문자
#   ex) StudentName
...
# 개발자: Web(프론트엔드), App(Android, Apple), 웹 퍼블리셔
# 웹 디자이너
...
# 동적 출력!
print("-" * 200)
student_num = "20233061"
student_name = "Seodongheon"
# 출력 예: "저는 조선대학교 20233061, Seodongheon 입니다."
print("저는 조선대학교 20233061, Seodongheon 입니다.")  # 하드 코딩 -> 쓰지 말기

# 1. format() 함수 - Old
print("저는 조선대학교 {}, {} 입니다.".format(student_num, student_name))

# 2. f-string - New
print(f"저는 조선대학교 {student_num}, {student_name} 입니다.",)
